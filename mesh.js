...
import { generatePoints } from './fake_generate-points';
 ...
 *
 * @param {Uint16Array} pointData - data read from the mesh file
 * @returns {{points: number[][], peaks_index: number[]}}
 */
function extractPoints(pointData) {
...
async function choosePoints() {
    ...
    if (param.spacing === 5) {
        ...
        let extraction = extractPoints(generatePoints());
