...
import { textureSize } from './config';
...
const fbo_texture_size = textureSize;
...
class Renderer {
    constructor (mesh) {
        ...
        this.screenshotCanvas = /** @type{HTMLCanvasElement} */(document.getElementById('mapgen4-screenshot'));
    ...
    resizeCanvas() {
        ...
        size = textureSize; // could be smaller to increase performance
