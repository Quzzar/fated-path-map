...
function displayCurrentTool() {
    ...
    for (let c of docment.querySelectorAll("."+className)) {
        c.classList.remove(className);
    }
    docment.getElementById(currentTool).classList.add(className);
    docment.getElementById(currentSize).classList.add(className);
}*/
...
/*
const output = docment.getElementById('mapgen4');
new Draggable({
